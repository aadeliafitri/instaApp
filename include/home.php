    ...
    <section id="posts" class="posts">
      <div class="container" data-aos="fade-up">
        <div class="row g-5">
          <div class="col-lg-4">
            <?php 
                $sql_b = "SELECT `p`.`caption`, `p`.`foto`, `u`.`username` FROM `post` `p` inner join `user` `u` order by id_post desc limit 1";
                //echo $sql_b;
            ...
            <div class="post-entry-1 lg">
              <a href="single-post.html"><img src="foto/<?php echo $foto;?>" alt="" class="img-fluid"></a>
              <div class="post-meta"><span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
              <!-- <h2><a href="single-post.html">11 Work From Home Part-Time Jobs You Can Do Now</a></h2> -->
              <p class="mb-4 d-block"><?php echo $caption;?></p>

              <div class="d-flex align-items-center author">
                <!-- <div class="photo"><img src="assets/img/person-1.jpg" alt="" class="img-fluid"></div> -->
                <div class="name">
                  <h3 class="m-0 p-0">@<?php echo $username;?></h3>
                </div>
              </div>
            </div>
            <?php }?>
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              ...
              <?php 
                            $sql_b = "SELECT `id_post`,`caption`, `foto` FROM `post` limit 3";
                            //echo $sql_b;
                            $query_b = mysqli_query($koneksi,$sql_b);
                            while($data_b = mysqli_fetch_row($query_b)){
                                $id_post= $data_b[0];
              ...
              ?>
                <div class="post-entry-1">
                  <a href="index.php?include=detail-post&data=<?php echo $id_post;?>"><img src="foto/<?php echo $foto;?>" alt="" class="img-fluid"></a>
                  <div class="post-meta"><span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                  <p><?php echo $caption;?></p>
                  <a href="index.php?include=detail-post&data=<?php echo $id_post;?>">read more</a>
                </div>
                <?php }?>
              </div>
